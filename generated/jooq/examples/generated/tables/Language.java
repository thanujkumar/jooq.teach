...
public class Language extends TableImpl<LanguageRecord> {
    ...
    private static final long serialVersionUID = -1575580947;
    ...
    /**
     * Create a <code>JOOQDATA.LANGUAGE</code> table reference
     */
    public Language() {
    ...
    /**
     * Create an aliased <code>JOOQDATA.LANGUAGE</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SYS_C007999);
    }
    ...
    public List<UniqueKey<LanguageRecord>> getKeys() {
        return Arrays.<UniqueKey<LanguageRecord>>asList(Keys.SYS_C007999);
    }
